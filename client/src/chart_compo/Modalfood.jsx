        ...
        <div className='d-inline-block m-3'>
            <div className="card" style={{ width: "18rem" }}>
                ...
                <div className="card-body">
                    ...
                    <button onClick={() => { handleOnClick(imgtxt, price, counter) }} className="btn btn-primary btn-sm mx-4">Editar</button> 
                    <button onClick={() => { handleOnClick(imgtxt, price, counter) }} className="btn btn-primary btn-sm mx-4">Añadir</button> 
                    </div>       
                </div>
            </div>
        </div>
